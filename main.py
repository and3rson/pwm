...
'''
simplewm.py
Idea By Joshua D. Bartlett, March 2011
Improved by Andrew Dunai, 2017.
...
class WM(object):
    def __init__(self, display):
        ...
        self.event_dispatch_table = {
            ...
            # Xlib.protocol.event.ClientMessage: self.client_message
    ...
    def handle_client_message(self, event, *args):
        print event.window.configure(x=0, y=0, width=300, height=100)
